...
const ConnectToDatabase = () => {
  ...
  return (
    <div className="flex flex-col w-3/4 items-center pb-2">
      <button className={` hover:underline text-color-animation text-color-animation-hover ${isExpanded ? 'text-color-animation-clicked':''}`} onClick={() => setIsExpanded(!isExpanded)}>
